...
import {HeaderContainer, ListingItemContainer, AdvancedSearchContainer, FooterContainer} from "../containers";
                        ...
                        <Section.FlexItem width="65%">
                            ...
                            <Section.Content>
                                {properties.map((featured) => (
                                    <ListingItemContainer key={featured.id} featured={featured} width="49%"/>
                                ))}
                            </Section.Content>
                            <Section.Footer>
