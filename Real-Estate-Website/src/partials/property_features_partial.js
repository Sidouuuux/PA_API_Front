    ...
    return (
        <Property.Info>
            <Property.InfoHeader onClick={contentHandler}>
                ...
                <Property.Icon name={featuresShown ? "fas fa-chevron-up" : "fas fa-chevron-down"} info/>
            </Property.InfoHeader>
    ...
    return (
        <Property.Info>
            <Property.InfoHeader onClick={contentHandler}>
                ...
                <Property.Icon name={amenitiesShown ? "fas fa-chevron-up" : "fas fa-chevron-down"} info/>
            </Property.InfoHeader>
    ...
    return (
        <Property.Info>
            <Property.InfoHeader onClick={contentHandler}>
                ...
                <Property.Icon name={addressShown ? "fas fa-chevron-up" : "fas fa-chevron-down"} info/>
            </Property.InfoHeader>
    ...
    return (
        <Property.Info>
            <Property.InfoHeader onClick={contentHandler}>
                ...
                <Property.Icon name={descriptionShown ? "fas fa-chevron-up" : "fas fa-chevron-down"} info/>
            </Property.InfoHeader>
